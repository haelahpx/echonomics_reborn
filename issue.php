...
<body class="bg-gray-100">
            ...
            <div class="bg-white rounded-md p-4 shadow-md hover:shadow-lg transition duration-300 mb-4">
                ...
                <form method="post" enctype="multipart/form-data" class="mb-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        <input type="file" name="image" class="mb-2 md:mb-0" />
                        <input type="text" name="desc" class="border-gray-300 border rounded-md p-2 mb-2 md:mr-2 md:w-3/4 focus:outline-none focus:border-blue-500" placeholder="Enter Description">
    ...
    <div class="space-y-4">
        <?php while ($row = mysqli_fetch_assoc($result2)) : ?>
            <div class="bg-gray-100 rounded-md p-4 shadow-md hover:shadow-lg transition duration-300">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <?php 
                            ...
                            if (!empty($customer_image_row['image'])) :
                        ?>
                            <img src="images/<?php echo $customer_image_row['image']; ?>" alt="Customer Image" class="mt-2 rounded-full" width="50px">
                        <?php endif; ?>
                    </div>
                    <?php if ($row['customer_id'] == $idd) : ?>
                        <form>
                            <button class="bg-red-500 text-white rounded-md px-4 py-2 hover:bg-red-600 transition duration-300">Delete</button>
                        </form>
                    <?php endif; ?>
                </div>
            </div>
